...
<div class="container-fluid container-sm">
    <form class="border border-light rounded p-5" action="/costumer/save/${costumer.id}" method="post">
        <h3>Atualização de Solicitantes</h3>
        ...
        <h6>Informações Cadastrais</h6>
            ...
            <div class="col form-group">
                ...
                <select class="form-select" id="tipoCliente" name="tipoCliente">
                    <option value="APOSENTADOS" ${costumer.tipoCliente == 'APOSENTADOS' ? 'selected' : ''}>Aponsentados e Pensionistas</option>
                    <option value="SERVIDORES" ${costumer.tipoCliente == 'SERVIDORES' ? 'selected' : ''}>Servidores Públicos</option>
                    <option value="FGTS" ${costumer.tipoCliente == 'FGTS' ? 'selected' : ''}>Antecipação do FGTS</option>
                </select>
            </div>
            <div class="col form-group">
                <label>CPF</label>
            ...
            <div class="col form-group">
                <label>Idade</label>
                <input type="number" name="idade" step="1" min="1" value="${costumer.idade}" class="form-control text-right">
            </div>
        </div>
        ...
        <div class="py-3 mt-4 mb-2 row  border-start border-5  border-primary rounded shadow-sm">
            ...
            <div class=" col form-group ">
                ...
                <input type="number" name="rendaTotal" step="0.01" min="0.00" value="${costumer.rendaTotal}" class="form-control text-right">
            </div>
            <div class=" col form-group">
                <label>Saldo FGTS</label>
                <input type="number" name="saldoFgts" step="0.01" min="0.00" value="${costumer.saldoFgts}" class="form-control text-right">
            </div>
            <div class=" col form-group">
                <label>Limite Total Total</label>
                <input type="number" name="limiteTotal" step="0.01" min="0.00" value="${costumer.limiteTotal}" class="form-control text-right">
            </div>
            <div class=" col form-group">
                <label>Limite Total Disponível</label>
                <input type="number" name="limiteDisponivel" step="0.01" min="0.00" value="${costumer.limiteDisponivel}" class="form-control text-right">
            </div>
            <div class="col form-group">
                <label>Score</label>
                <input type="number" name="score" step="1" min="1" value="${costumer.score}" class="form-control text-right">
            </div>
            <div class="col form-group">
